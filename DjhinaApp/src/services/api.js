...
export function normalizeEvent(e) {
  ...
  return {
    ...
    organizer: {
      ...
      avatar:   e.organizer_avatar ? (e.organizer_avatar.startsWith('http') ? e.organizer_avatar : `${API_BASE}${e.organizer_avatar}`) : '',
...
export function normalizeTicket(t) {
  return {
    ...
    eventCover:    (() => { const c = t.event_cover || t.cover_image || ''; return c && !c.startsWith('http') ? `${API_BASE}${c}` : c; })(),
